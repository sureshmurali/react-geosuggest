...
import MaterialUITextfield from './material';

import filterInputAttributes from './filter-input-attributes';

var RunMDL = new MaterialUITextfield;
/**
 * The input field
  ...
  render() {
    ...
    return (
      ...
      <div className="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
          ...
          onBlur={this.onBlur} />
        <label className="mdl-textfield__label" htmlFor="sample1">{this.props.placeholderMaterial}</label>
      </div>
    </div>
      );
  }
